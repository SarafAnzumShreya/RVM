...
//輸入WIFI連線帳號密碼
const char* ssid = "monir zx online";
const char* password = "01718146157";

//輸入AP端連線帳號密碼  http://192.168.4.1
const char* apssid = "esp32-cam1";
...
#include <HTTPClient.h>        //視訊函式
#include "soc/soc.h"             //用於電源不穩不重開機 
#include "soc/rtc_cntl_reg.h"    //用於電源不穩不重開機 
#include "quirc.h"
#include <HardwareSerial.h>
#include "esp_system.h"
String ID = "AKfycbxOATD7b1rALzoFIdvE810D53u7oJHPkEKzCCcWP9N5ZNUB5_PsVKWlEk_Om-SNOkuasQ"; //--> spreadsheet script ID
...
#define BUZZER_PIN        15  // ESP32-cam pin GPIO15 connected to Buzzer's pin
 
void update_google_sheet(String id)
{
  ...
  String url = "/macros/s/" + ID + "/exec?num=";
...
void dumpData(const struct quirc_data *data)
{
  ...
  update_google_sheet(QRCodeResult); 
}
